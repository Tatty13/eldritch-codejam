...
1. сложные карты имеют щупальцы вокруг названия (см. Синюю карту ниже в примере)
2. обычные карты не умеют никаких знаков (см. Коричневую карту в примере)
3. легкие карты имеют изображение снежинок вокруг названия (см. Зеленую карту в примере)
...
Для задания подготовленны ассеты карт, а также файлы с данными этих карт.
...
[Деплой](https://tatty13.github.io/eldritch-codejam/eldrich/)
